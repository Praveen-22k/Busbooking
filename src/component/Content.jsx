...
<p style={{color:'#B027F5'}}>With 5200+ bus operators and 730000+ routes on TicketEasy, you can easily find buses to your destination. You can check the best price with exclusive discounts and offers when booking train or bus tickets.</p>
    </div>
  )
}
